...
const ADMIN_INBOX_TRANSITIONS: TransitionMap = {
  ...
  [TICKET_STATUS.WAITING_BUDGET]: [TICKET_STATUS.WAITING_BUDGET_APPROVAL, TICKET_STATUS.WAITING_PRELIM_ACTIONS, TICKET_STATUS.WAITING_EXECUTION, TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.CANCELED],
  [TICKET_STATUS.WAITING_BUDGET_APPROVAL]: [TICKET_STATUS.WAITING_PRELIM_ACTIONS, TICKET_STATUS.WAITING_EXECUTION, TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.CLOSED, TICKET_STATUS.CANCELED],
  [TICKET_STATUS.WAITING_PRELIM_ACTIONS]: [TICKET_STATUS.WAITING_EXECUTION, TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.CANCELED],
  [TICKET_STATUS.WAITING_EXECUTION]: [TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.CANCELED],
  ...
  [TICKET_STATUS.WAITING_CONTRACT_UPLOAD]: [TICKET_STATUS.WAITING_PRELIM_ACTIONS, TICKET_STATUS.WAITING_EXECUTION, TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.CANCELED],
  [TICKET_STATUS.WAITING_CONTRACT_APPROVAL]: [TICKET_STATUS.WAITING_PRELIM_ACTIONS, TICKET_STATUS.WAITING_EXECUTION, TICKET_STATUS.IN_PROGRESS, TICKET_STATUS.CANCELED],
};
