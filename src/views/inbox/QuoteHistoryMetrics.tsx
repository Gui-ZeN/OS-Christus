  ...
  return (
    <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-4">
      <div className="rounded-sm border border-roman-border bg-roman-surface p-3">
        <div className="text-[11px] uppercase tracking-widest text-roman-text-sub">Media</div>
        <div className="mt-1 text-lg font-serif text-roman-text-main">{formatBudgetHistoryValue(history.averageQuoteValue)}</div>
      </div>
      <div className="rounded-sm border border-roman-border bg-roman-surface p-3">
        <div className="text-[11px] uppercase tracking-widest text-roman-text-sub">Faixa</div>
      ...
      <div className="rounded-sm border border-roman-border bg-roman-surface p-3">
        <div className="text-[11px] uppercase tracking-widest text-roman-text-sub">Último comparável</div>
      ...
      <div className="rounded-sm border border-roman-border bg-roman-surface p-3">
        <div className="text-[11px] uppercase tracking-widest text-roman-text-sub">Referencias</div>
