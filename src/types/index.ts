...
export type ViewState = 'revisao-semanal' | 'confirmar-visita' | 'landing' | 'login' | 'password-reset' | 'home' | 'today' | 'inbox' | 'os-board' | 'users' | 'kpi' | 'settings' | 'tracking' | 'public-form' | 'finance' | 'email-health' | 'audit-logs';
